...
server.post("/login", requestValidate, async (request, response) => {
...
server.post("/register", requestValidate, async (request, response) => {
    try {
...
mongoose.connect(`mongodb://${process.env.DBUSER}:${process.env.DBPASS}@mongo:27017/mongection`, {
